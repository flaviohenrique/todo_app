...
export type SelectAvatarEventHandler = (file: File | null) => void;
...
export const AvatarForm: VFC<AvatarFormProps> = ({
  onSubmit,
  onSelectAvatarFile,
  currentAvatarImgUrl,
  isLoading = false,
    ...
    <form onSubmit={handleSubmit(onSubmitHandler)}>
      <FormControl width="100%" isInvalid={errors.avatar !== undefined}>
        ...
        <HStack spacing={4}>
          ...
          <FormInputFile
            {...register("avatar", { required: true, onChange: onChangeFile })}
          />
          <Button
            type="submit"
            colorScheme="teal"
