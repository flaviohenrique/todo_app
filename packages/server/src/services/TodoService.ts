...
export class TodoService {
    ...
    async update(id:number, params: Partial<Todo> = {}): Promise<Todo|undefined> {
    ...
    async create(params: Partial<Todo> = {}): Promise<Todo|undefined> {
        const todo = new Todo(params.description || "", new Date(), new Date(), undefined, params.more_description)    
